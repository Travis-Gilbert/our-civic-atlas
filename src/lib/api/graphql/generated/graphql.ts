...
export type EventApplicationEmailSendInput = {
  applicationId: string | number;
  bodyMarkdown: string;
  eventSlug: string;
  idempotencyKey?: string | null | undefined;
  notesDocId?: string | number | null | undefined;
...
export type EventEmailChannelConfigureInput = {
  eventSlug: string;
  expectedVersion?: number | null | undefined;
  provider?: string | null | undefined;
  /**
   * Human-readable deployment label only, e.g. "Railway: Resend Starter".
   * Provider secrets and service identifiers stay out of GraphQL.
   */
  providerDeploymentLabel?: string | null | undefined;
  replyRoutingMode?: EventEmailReplyRoutingMode | null | undefined;
  replyToEmail?: string | null | undefined;
  senderEmail?: string;
...
/**
 * Delivery lifecycle known from the outbound provider. Resend owns these
 * states; reply state is tracked separately because delivery webhooks do not
 * prove that a recipient replied.
 */
export type EventEmailDeliveryState =
  | 'BOUNCED'
  | 'CLICKED'
  | 'COMPLAINED'
  | 'DELIVERED'
...
export type EventEmailOutreachUpdateInput = {
  deliveryState?: EventEmailDeliveryState | null | undefined;
  expectedVersion: number;
  notesDocId?: string | number | null | undefined;
  outreachId: string | number;
  replyState?: EventEmailReplyState | null | undefined;
};

/** Where the event expects reply detection to come from. */
export type EventEmailReplyRoutingMode =
  | 'GMAIL_METADATA'
  | 'MANUAL'
  | 'RESEND_INBOUND';

/**
 * Human workflow state for replies. Gmail metadata/history sync or Resend
 * inbound can flip this to REPLIED; organizers can mark DEFERRED or MANUAL.
 */
export type EventEmailReplyState =
  | 'DEFERRED'
  | 'MANUAL'
  | 'NOT_REPLIED'
  | 'REPLIED';

export type EventSetTimeProjectionInput = {
  actName: string;
  endMinute: number;
  setTimeRaw?: string | null | undefined;
  sourceKey: string;
  startMinute: number;
};
...
export type ExportCivicRowsToGoogleSheetInput = {
  /** When true, return the export count/range without writing to Google. */
  dryRun?: boolean | null | undefined;
  eventSlug?: string | null | undefined;
  range?: string | null | undefined;
  rows: Array<GoogleSheetCivicRowInput>;
...
export type GoogleSheetCivicRowInput = {
  fields: Record<string, unknown>;
  sourceId?: string | null | undefined;
};

export type GoogleSheetSyncInput = {
  eventSlug?: string | null | undefined;
  range?: string | null | undefined;
  spreadsheetId?: string | null | undefined;
  targetKind?: string | null | undefined;
...
export type ProjectEventSetTimesInput = {
  eventSlug: string;
  projections: Array<EventSetTimeProjectionInput>;
  /**
   * Full-snapshot semantics: when true, projections absent from this batch are
   * removed for the layer. Default false (upsert only).
   */
  pruneMissing?: boolean | null | undefined;
};
...
export type EventEmailChannelQueryVariables = Exact<{
  tenantSlug?: string;
  eventSlug: string;
}>;


export type EventEmailChannelQuery = { eventEmailChannel: { id: string, eventLayerId: string, provider: string, senderEmail: string, senderName: string | null, replyToEmail: string | null, replyRoutingMode: EventEmailReplyRoutingMode, deliveryWebhookStatus: string, providerDeploymentLabel: string | null, createdAt: string | null, updatedAt: string | null, version: number } | null };

export type EventEmailOutreachQueryVariables = Exact<{
  tenantSlug?: string;
  eventSlug: string;
...
export type EventEmailOutreachQuery = { eventEmailOutreach: Array<{ id: string, eventLayerId: string, applicationId: string | null, recipientEmail: string, subject: string, previewText: string | null, resendEmailId: string | null, messageId: string | null, replyToEmail: string | null, deliveryState: EventEmailDeliveryState, replyState: EventEmailReplyState, notesDocId: string | null, createdByUserId: string | null, sentAt: string | null, lastEventAt: string | null, createdAt: string | null, updatedAt: string | null, version: number }> };

export type ConfigureEventEmailChannelMutationVariables = Exact<{
  input: EventEmailChannelConfigureInput;
}>;


export type ConfigureEventEmailChannelMutation = { configureEventEmailChannel: { staleWrite: boolean, channel: { id: string, eventLayerId: string, provider: string, senderEmail: string, senderName: string | null, replyToEmail: string | null, replyRoutingMode: EventEmailReplyRoutingMode, deliveryWebhookStatus: string, providerDeploymentLabel: string | null, createdAt: string | null, updatedAt: string | null, version: number } | null } };

export type SendEventApplicationEmailMutationVariables = Exact<{
  input: EventApplicationEmailSendInput;
}>;


export type SendEventApplicationEmailMutation = { sendEventApplicationEmail: { staleWrite: boolean, outreach: { id: string, eventLayerId: string, applicationId: string | null, recipientEmail: string, subject: string, previewText: string | null, resendEmailId: string | null, messageId: string | null, replyToEmail: string | null, deliveryState: EventEmailDeliveryState, replyState: EventEmailReplyState, notesDocId: string | null, sentAt: string | null, lastEventAt: string | null, version: number } | null } };

export type UpdateEventEmailOutreachMutationVariables = Exact<{
  input: EventEmailOutreachUpdateInput;
}>;


export type UpdateEventEmailOutreachMutation = { updateEventEmailOutreach: { staleWrite: boolean, outreach: { id: string, deliveryState: EventEmailDeliveryState, replyState: EventEmailReplyState, notesDocId: string | null, lastEventAt: string | null, updatedAt: string | null, version: number } | null } };
...
export type ProjectEventSetTimesMutationVariables = Exact<{
  input: ProjectEventSetTimesInput;
}>;


export type ProjectEventSetTimesMutation = { projectEventSetTimes: { upserted: number, pruned: number, projections: Array<{ id: string, sourceKey: string, actName: string, startMinute: number, endMinute: number, projectedAt: string | null, version: number }> } };

export type EventSetTimeProjectionsQueryVariables = Exact<{
  eventSlug: string;
}>;


export type EventSetTimeProjectionsQuery = { eventSetTimeProjections: Array<{ id: string, sourceKey: string, actName: string, setTimeRaw: string | null, startMinute: number, endMinute: number, projectedAt: string | null, version: number }> };
...
export type GoogleWorkspaceConnectionQueryVariables = Exact<{
  tenantSlug?: string;
  eventSlug: string;
}>;


export type GoogleWorkspaceConnectionQuery = { googleWorkspaceConnection: { tenantSlug: string, eventSlug: string, status: string, googleAccountEmail: string | null, scopes: Array<string>, sheetsConfigured: boolean, gmailConfigured: boolean, linkedSpreadsheetId: string | null, defaultSheetRange: string | null, lastCheckedAt: string | null, message: string | null } };

export type SyncGoogleSheetCivicRowsMutationVariables = Exact<{
  input: GoogleSheetSyncInput;
}>;


export type SyncGoogleSheetCivicRowsMutation = { syncGoogleSheetCivicRows: { rowCount: number, importedAt: string | null, message: string | null, connection: { status: string, googleAccountEmail: string | null, sheetsConfigured: boolean, gmailConfigured: boolean, linkedSpreadsheetId: string | null, defaultSheetRange: string | null, message: string | null }, rows: Array<{ sourceId: string, rowNumber: number, targetKind: string, fields: Record<string, unknown>, rowHash: string }> } };

export type ExportCivicRowsToGoogleSheetMutationVariables = Exact<{
  input: ExportCivicRowsToGoogleSheetInput;
}>;


export type ExportCivicRowsToGoogleSheetMutation = { exportCivicRowsToGoogleSheet: { dryRun: boolean, rowCount: number, updatedRange: string | null, updatedCells: number, exportedAt: string | null, message: string | null, connection: { status: string, googleAccountEmail: string | null, sheetsConfigured: boolean, linkedSpreadsheetId: string | null, defaultSheetRange: string | null, message: string | null } } };
...
export const EventEmailChannelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EventEmailChannel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tenantSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"defaultValue":{"kind":"StringValue","value":"flint","block":false}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"eventEmailChannel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tenantSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tenantSlug"}}},{"kind":"Argument","name":{"kind":"Name","value":"eventSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"eventLayerId"}},{"kind":"Field","name":{"kind":"Name","value":"provider"}},{"kind":"Field","name":{"kind":"Name","value":"senderEmail"}},{"kind":"Field","name":{"kind":"Name","value":"senderName"}},{"kind":"Field","name":{"kind":"Name","value":"replyToEmail"}},{"kind":"Field","name":{"kind":"Name","value":"replyRoutingMode"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryWebhookStatus"}},{"kind":"Field","name":{"kind":"Name","value":"providerDeploymentLabel"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}}]}}]} as unknown as DocumentNode<EventEmailChannelQuery, EventEmailChannelQueryVariables>;
export const EventEmailOutreachDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EventEmailOutreach"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tenantSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"defaultValue":{"kind":"StringValue","value":"flint","block":false}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"applicationId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"deliveryState"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"EventEmailDeliveryState"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"replyState"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"EventEmailReplyState"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"eventEmailOutreach"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tenantSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tenantSlug"}}},{"kind":"Argument","name":{"kind":"Name","value":"eventSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}}},{"kind":"Argument","name":{"kind":"Name","value":"applicationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"applicationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"deliveryState"},"value":{"kind":"Variable","name":{"kind":"Name","value":"deliveryState"}}},{"kind":"Argument","name":{"kind":"Name","value":"replyState"},"value":{"kind":"Variable","name":{"kind":"Name","value":"replyState"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"eventLayerId"}},{"kind":"Field","name":{"kind":"Name","value":"applicationId"}},{"kind":"Field","name":{"kind":"Name","value":"recipientEmail"}},{"kind":"Field","name":{"kind":"Name","value":"subject"}},{"kind":"Field","name":{"kind":"Name","value":"previewText"}},{"kind":"Field","name":{"kind":"Name","value":"resendEmailId"}},{"kind":"Field","name":{"kind":"Name","value":"messageId"}},{"kind":"Field","name":{"kind":"Name","value":"replyToEmail"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryState"}},{"kind":"Field","name":{"kind":"Name","value":"replyState"}},{"kind":"Field","name":{"kind":"Name","value":"notesDocId"}},{"kind":"Field","name":{"kind":"Name","value":"createdByUserId"}},{"kind":"Field","name":{"kind":"Name","value":"sentAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastEventAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}}]}}]} as unknown as DocumentNode<EventEmailOutreachQuery, EventEmailOutreachQueryVariables>;
export const ConfigureEventEmailChannelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ConfigureEventEmailChannel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EventEmailChannelConfigureInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"configureEventEmailChannel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"channel"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"eventLayerId"}},{"kind":"Field","name":{"kind":"Name","value":"provider"}},{"kind":"Field","name":{"kind":"Name","value":"senderEmail"}},{"kind":"Field","name":{"kind":"Name","value":"senderName"}},{"kind":"Field","name":{"kind":"Name","value":"replyToEmail"}},{"kind":"Field","name":{"kind":"Name","value":"replyRoutingMode"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryWebhookStatus"}},{"kind":"Field","name":{"kind":"Name","value":"providerDeploymentLabel"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}},{"kind":"Field","name":{"kind":"Name","value":"staleWrite"}}]}}]}}]} as unknown as DocumentNode<ConfigureEventEmailChannelMutation, ConfigureEventEmailChannelMutationVariables>;
export const SendEventApplicationEmailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SendEventApplicationEmail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EventApplicationEmailSendInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sendEventApplicationEmail"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"outreach"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"eventLayerId"}},{"kind":"Field","name":{"kind":"Name","value":"applicationId"}},{"kind":"Field","name":{"kind":"Name","value":"recipientEmail"}},{"kind":"Field","name":{"kind":"Name","value":"subject"}},{"kind":"Field","name":{"kind":"Name","value":"previewText"}},{"kind":"Field","name":{"kind":"Name","value":"resendEmailId"}},{"kind":"Field","name":{"kind":"Name","value":"messageId"}},{"kind":"Field","name":{"kind":"Name","value":"replyToEmail"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryState"}},{"kind":"Field","name":{"kind":"Name","value":"replyState"}},{"kind":"Field","name":{"kind":"Name","value":"notesDocId"}},{"kind":"Field","name":{"kind":"Name","value":"sentAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastEventAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}},{"kind":"Field","name":{"kind":"Name","value":"staleWrite"}}]}}]}}]} as unknown as DocumentNode<SendEventApplicationEmailMutation, SendEventApplicationEmailMutationVariables>;
export const UpdateEventEmailOutreachDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateEventEmailOutreach"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EventEmailOutreachUpdateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateEventEmailOutreach"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"outreach"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryState"}},{"kind":"Field","name":{"kind":"Name","value":"replyState"}},{"kind":"Field","name":{"kind":"Name","value":"notesDocId"}},{"kind":"Field","name":{"kind":"Name","value":"lastEventAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}},{"kind":"Field","name":{"kind":"Name","value":"staleWrite"}}]}}]}}]} as unknown as DocumentNode<UpdateEventEmailOutreachMutation, UpdateEventEmailOutreachMutationVariables>;
...
export const ProjectEventSetTimesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ProjectEventSetTimes"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectEventSetTimesInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectEventSetTimes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"upserted"}},{"kind":"Field","name":{"kind":"Name","value":"pruned"}},{"kind":"Field","name":{"kind":"Name","value":"projections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sourceKey"}},{"kind":"Field","name":{"kind":"Name","value":"actName"}},{"kind":"Field","name":{"kind":"Name","value":"startMinute"}},{"kind":"Field","name":{"kind":"Name","value":"endMinute"}},{"kind":"Field","name":{"kind":"Name","value":"projectedAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}}]}}]}}]} as unknown as DocumentNode<ProjectEventSetTimesMutation, ProjectEventSetTimesMutationVariables>;
export const EventSetTimeProjectionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EventSetTimeProjections"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"eventSetTimeProjections"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"eventSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sourceKey"}},{"kind":"Field","name":{"kind":"Name","value":"actName"}},{"kind":"Field","name":{"kind":"Name","value":"setTimeRaw"}},{"kind":"Field","name":{"kind":"Name","value":"startMinute"}},{"kind":"Field","name":{"kind":"Name","value":"endMinute"}},{"kind":"Field","name":{"kind":"Name","value":"projectedAt"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}}]}}]} as unknown as DocumentNode<EventSetTimeProjectionsQuery, EventSetTimeProjectionsQueryVariables>;
...
export const GoogleWorkspaceConnectionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GoogleWorkspaceConnection"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tenantSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"defaultValue":{"kind":"StringValue","value":"flint","block":false}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"googleWorkspaceConnection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tenantSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tenantSlug"}}},{"kind":"Argument","name":{"kind":"Name","value":"eventSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eventSlug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantSlug"}},{"kind":"Field","name":{"kind":"Name","value":"eventSlug"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"googleAccountEmail"}},{"kind":"Field","name":{"kind":"Name","value":"scopes"}},{"kind":"Field","name":{"kind":"Name","value":"sheetsConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"gmailConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"linkedSpreadsheetId"}},{"kind":"Field","name":{"kind":"Name","value":"defaultSheetRange"}},{"kind":"Field","name":{"kind":"Name","value":"lastCheckedAt"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]} as unknown as DocumentNode<GoogleWorkspaceConnectionQuery, GoogleWorkspaceConnectionQueryVariables>;
export const SyncGoogleSheetCivicRowsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncGoogleSheetCivicRows"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GoogleSheetSyncInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"syncGoogleSheetCivicRows"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rowCount"}},{"kind":"Field","name":{"kind":"Name","value":"importedAt"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"connection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"googleAccountEmail"}},{"kind":"Field","name":{"kind":"Name","value":"sheetsConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"gmailConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"linkedSpreadsheetId"}},{"kind":"Field","name":{"kind":"Name","value":"defaultSheetRange"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"Field","name":{"kind":"Name","value":"rows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sourceId"}},{"kind":"Field","name":{"kind":"Name","value":"rowNumber"}},{"kind":"Field","name":{"kind":"Name","value":"targetKind"}},{"kind":"Field","name":{"kind":"Name","value":"fields"}},{"kind":"Field","name":{"kind":"Name","value":"rowHash"}}]}}]}}]}}]} as unknown as DocumentNode<SyncGoogleSheetCivicRowsMutation, SyncGoogleSheetCivicRowsMutationVariables>;
export const ExportCivicRowsToGoogleSheetDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ExportCivicRowsToGoogleSheet"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ExportCivicRowsToGoogleSheetInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"exportCivicRowsToGoogleSheet"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dryRun"}},{"kind":"Field","name":{"kind":"Name","value":"rowCount"}},{"kind":"Field","name":{"kind":"Name","value":"updatedRange"}},{"kind":"Field","name":{"kind":"Name","value":"updatedCells"}},{"kind":"Field","name":{"kind":"Name","value":"exportedAt"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"connection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"googleAccountEmail"}},{"kind":"Field","name":{"kind":"Name","value":"sheetsConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"linkedSpreadsheetId"}},{"kind":"Field","name":{"kind":"Name","value":"defaultSheetRange"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<ExportCivicRowsToGoogleSheetMutation, ExportCivicRowsToGoogleSheetMutationVariables>;
