  ...
  if (notFound) {
    return (
      <CenteredState>
        ...
        <Link
          href="/open-flint-atlas/reconstruction-engine/building%3Acarriage-town%3A1/1925"
          className="atelier-replay-button"
          style={{ marginTop: 16, display: "inline-block" }}
        >
          Open the Reconstruction Engine on Whaley House
        </Link>
      </CenteredState>
    );
  }
  ...
  if (error) {
    return (
      <CenteredState>
        ...
        <p className="atelier-dossier__caption" style={{ marginTop: 8 }}>
          The Reconstruction EngineThe Atelier&apos;s save mutationapos;s save mutation is not yet implemented on the
